    ...
    index: {
        ...
        portfolio: {
            ...
            deeplog: {
                title: 'DeepLog',
                description:
                    'System of website to manage the website like a music playlist for people use websites',
            },
            deeplab: {
                title: 'DeepLab',
                description:
                    'We will disseminate information based on the Web, AI, and Quantum Computing',
            },
            deepmuseum: {
                title: 'DeepMuseum',
                description:
