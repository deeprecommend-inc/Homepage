            ...
            <Container>
              <Row className="justify-content-center">
                <Col md="7" className="text-center">
                  <h1 className="title font-bold">{t.index.technologyUsed.title}</h1>
          ...
          <div className="testimonial3 spacer">
            <Container>
              <Row className="testi3 m-t-40 justify-content-center">
                <Col lg="4" md="6">
                  <Card className="card-shadow" data-aos="fade-up-right">
                    <CardBody>
                                    ...
                                    return (
                                        <Col lg="4" md="6" className="mt-2">
                                          <a href={tech.url} target="_blank" rel="noopener noreferrer">
                                            <Image src={tech.img} alt="wrapkit" className="circle" />
                                            <p className="font-10">{tech.name}</p>
                                          </a>
                                        </Col>
                                    )
                                })
                        ...
                        <Row className="testi3 m-t-40 justify-content-start">
                            {
                                techUsed.ai.map(tech => {
                                    return (
                                        <Col lg="4" md="6" className="mt-2" href={tech.url} target="_blank" rel="noopener noreferrer">
                                          <a href={tech.url} target="_blank" rel="noopener noreferrer">
                                            <Image src={tech.img} alt="wrapkit" className="circle" />
                                            <p className="font-10">{tech.name}</p>
                                          </a>
                ...
                <Col lg="4" md="6">
                  <Card className="card-shadow" data-aos="fade-up-left">
                    <CardBody>
                      <h6 className="font-light m-b-30 text-center">
                        Quantum
                      </h6>
