        ...
        <Container>
          <Row className="">
            <Col md="6" className="align-self-center">
              <span className="label label-rounded label-inverse">CmCn</span>
              <h1>
              ...
              <h6 className="my-5">
                ...
                CmCn solves all those problems! An interesting comedian meets an
                interesting partner! Currently Free!!
              </h6>
              <a
